...
const Space = () => {
  ...
  return (
    <main className="min-h-screen pt-[4rem] md:pt-[3.5rem] lg:pt-[6.5rem] w-[90%] xl:w-[85%] mx-auto space-y-8">
      <div className="space-y-4 md:space-y-5">
        <div className="flex flex-col lg:flex-row items-start lg:items-baseline-last  lg:justify-between">
          ...
          <p className="md:hidden text-[1rem] sm:text-[1.05rem]">
            {short_description}
          </p>
        </div>
        <div className="relative h-[17rem] sm:h-[20rem] md:h-[28rem] mx-auto rounded-[1.5rem]">
          <img
            src={inner_image}
            alt=""
            width={600}
            height={400}
            className="w-full h-full rounded-[.0rem] md:rounded-[.0rem] object-bottom object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent z-10"></div>
        </div>
      </div>
      <div className="my-[3rem] flex flex-col md:flex-row justify-between space-y-4">
        <div className="w-2/12 text-[1.1rem] xl:text-[1.4rem] text-[#0f592e] font-semibold leading-[1.5rem] md:leading-[1.6rem] font-marriweather uppercase">
          Our Offerings
        </div>
        <div className="w-full md:w-9/12 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 self-end gap-3">
          {features?.map(({ icon: Icon, ...f }) => (
            <div
              className={`${f.class} border border-neutral-400 text-[#081e10]  relative min-h-32 rounded-[.0rem]`}
            >
      ...
      <div className="my-[3rem] flex flex-col md:flex-row justify-between space-y-4">
        <div className="w-2/12 text-[1.1rem] xl:text-[1.4rem] text-[#0f592e] font-semibold leading-[1.5rem] sm:leading-[2.5rem] font-marriweather uppercase">
          Images
        </div>
        <div className="w-full md:w-9/12 flex flex-col gap-4 lg:gap-5">
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4 lg:gap-5 w-full ">
            <img
              ...
              className="h-[15rem] sm:h-[18rem] md:h-[20rem] w-full object-cover object-bottom lg:rounded-[.0rem]"
            />
            <img
              src={images.image2}
          ...
          <div className="h-[15rem] sm:h-[18rem] md:h-[20rem] w-full object-cover object-bottom ">
            <img
              ...
              className="h-full w-full object-cover lg:rounded-[.0rem]"
            />
          </div>
        </div>
      </div>
